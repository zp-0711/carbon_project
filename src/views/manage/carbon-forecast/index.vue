<template>
  ...
  <el-form-item label="碳汇造林树木种类">
      ...
      <el-form-item label="项目预计时间/年">
            <el-select class="w-all"  v-model="forecastForm.time" placeholder="请选择时间">
              <el-option
                v-for="item in scheduledTime"
                :key="item.value"
                :label="item.label"
                :value="item.value"
              >
  ...
  <el-form-item label="碳汇造林" class="delivery-a">
